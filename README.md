...
the mid-2010s. This project ports its engraving engine — the part that makes it special — from
~195K lines of C++/Carbon/QuickDraw to a modern Rust core with a Flutter UI.
