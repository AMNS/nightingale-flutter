...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ...
        ("BachEbSonata_20_2sizes", 3143909183612603693),
        ("BachEbSonata_20", 3143909183612603693),
        ("BachStAnne_63", 8291174837090955956),
        ("barline_types", 11826322165668403117),
        ("bass_clef_melody", 6143118881930782026),
        ("beamed_eighths", 16817476029656344587),
        ("BinchoisDePlus_17", 18291454421250138902),
        ...
        ("Debussy_Images_9", 14227428634781103396),
        ("dotted_notes", 15719983019693230465),
        ("GoodbyePorkPieHat", 8201738293098964968),
        ("grace_notes_test", 9369185261854780981),
        ("HBD_33", 5873949035295602585),
        ...
        ("KillingMe_36", 13187952362506014823),
        ("ledger_lines", 4530816715993400936),
        ("MahlerLiedVonDE_25", 10697533808418427574),
        ("MendelssohnOp7N1_2", 1155609259676820338),
        ("mixed_durations", 12316681405162711887),
        ("RavelScarbo_15", 7846796583325016405),
        ("rests_all_durations", 12343596771520387979),
        ("SchenkerDiagram_Chopin_6", 13775042079730522815),
        ("SchoenbergOp19N1_21", 794441199999146036),
        ...
        ("Webern_Op5N3_22", 5038468393195002446),
