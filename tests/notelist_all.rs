...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ...
        ("Debussy_Images_9", 13259790791829534387),
        ...
        ("MahlerLiedVonDE_25", 8549166328560173777),
        ("MendelssohnOp7N1_2", 568319640603992705),
        ("mixed_durations", 12316681405162711887),
        ("RavelScarbo_15", 3906755990270431604),
        ("rests_all_durations", 12343596771520387979),
        ("SchenkerDiagram_Chopin_6", 13775042079730522815),
        ("SchoenbergOp19N1_21", 4868012441300387231),
        ...
        ("Webern_Op5N3_22", 15800714655076660779),
