...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("accidentals", 14441294094946645086),
        ("BachEbSonata_20_2sizes", 10434230683261740555),
        ("BachEbSonata_20", 10434230683261740555),
        ("BachStAnne_63", 5622583725843486463),
        ("barline_types", 18087601599955517216),
        ("bass_clef_melody", 1076759392620619018),
        ("beamed_eighths", 850804376044104068),
        ("BinchoisDePlus_17", 9921212341862211272),
        ("chord_seconds", 12071350830517757000),
        ("chromatic_scale", 10061561477185934532),
        ("clef_change", 5708289015083570046),
        ("compound_meter", 15068442093929678770),
        ("Debussy_Images_9", 15546827418121526758),
        ("dotted_notes", 1549865980599485845),
        ("GoodbyePorkPieHat", 17967406902139967521),
        ("grace_notes_test", 10446116724133243600),
        ("HBD_33", 2191807963666586451),
        ("keysig_d_major", 9823914195146044174),
        ("keysig_eb_major", 2114330136606143954),
        ("keysig_flats_all", 1189029392368931558),
        ("keysig_sharps_all", 7331275479943604932),
        ("KillingMe_36", 13247530892177001822),
        ("ledger_lines", 11477736651233682171),
        ("MahlerLiedVonDE_25", 12132961151475615059),
        ("MendelssohnOp7N1_2", 11192539354044166530),
        ("mixed_durations", 6228460880586189991),
        ("RavelScarbo_15", 13849167125367843578),
        ("rests_all_durations", 12239015977785294581),
        ("SchenkerDiagram_Chopin_6", 14360620767564929064),
        ("SchoenbergOp19N1_21", 4909220787934832800),
        ("sixteenths_32nds", 3968924248868494670),
        ("TestMIDIChannels_3", 10651914334061065474),
        ("text_annotations", 3148182755274904803),
        ("tied_notes", 15025587835983941681),
        ("time_sig_changes", 4362645867719198346),
        ("tuplet_quintuplet", 3503043138889755049),
        ("tuplet_triplet", 2482725804168697115),
        ("two_voices", 15918767240102870236),
        ("Webern_Op5N3_22", 11503280932335916401),
        ("whole_notes", 203519566342081697),
        ("wide_intervals", 16191708781887358778),
    ]
    .into_iter()
    .collect();
