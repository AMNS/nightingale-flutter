...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("accidentals", 3630026503596862067),
        ("BachEbSonata_20_2sizes", 5090387090732858310),
        ("BachEbSonata_20", 5090387090732858310),
        ("BachStAnne_63", 645406926320851280),
        ("barline_types", 11826322165668403117),
        ("bass_clef_melody", 7311794916494775893),
        ("beamed_eighths", 16763450741617190630),
        ("BinchoisDePlus_17", 13905601383086288575),
        ("chord_seconds", 10261439549916567622),
        ("chromatic_scale", 7411720266735445093),
        ("clef_change", 13675144730715349278),
        ("compound_meter", 4181112991906527653),
        ("Debussy_Images_9", 16814110959558579329),
        ("dotted_notes", 9019575606520383003),
        ("GoodbyePorkPieHat", 3214489601089275824),
        ("grace_notes_test", 9369185261854780981),
        ("HBD_33", 2498748908012742104),
        ...
        ("KillingMe_36", 12225532608920470728),
        ("ledger_lines", 2182881559760452328),
        ("MahlerLiedVonDE_25", 3224247968976109463),
        ("MendelssohnOp7N1_2", 13847907994509405498),
        ("mixed_durations", 9250797622155078981),
        ("RavelScarbo_15", 3822507811573606383),
        ("rests_all_durations", 12326971471415668019),
        ("SchenkerDiagram_Chopin_6", 7894214250551900251),
        ("SchoenbergOp19N1_21", 11718855793188779128),
        ("sixteenths_32nds", 14082268549248662127),
        ("TestMIDIChannels_3", 14875383033318540217),
        ...
        ("wide_intervals", 15865473669563153289),
    ]
    .into_iter()
    .collect();
