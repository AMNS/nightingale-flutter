...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ...
        ("Debussy_Images_9", 15909392134893551857),
        ...
        ("MahlerLiedVonDE_25", 11181469897960863764),
        ("MendelssohnOp7N1_2", 4536793932038498754),
        ("RavelScarbo_15", 17645437608820948290),
        ("SchenkerDiagram_Chopin_6", 7638013679289342745),
        ("SchoenbergOp19N1_21", 8649723703973317502),
        ("TestMIDIChannels_3", 4823533993867358497),
        ("tuplet_triplet", 18359089158201898891),
        ("Webern_Op5N3_22", 17088904993874148619),
    ]
    .into_iter()
    .collect();
