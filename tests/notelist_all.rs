...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("accidentals", 15904981864621063406),
        ("BachEbSonata_20_2sizes", 5044076877042256278),
        ("BachEbSonata_20", 5044076877042256278),
        ("BachStAnne_63", 881973257569595476),
        ("barline_types", 3223521949771389300),
        ("bass_clef_melody", 3798962600051505084),
        ("beamed_eighths", 15144381784386434179),
        ("BinchoisDePlus_17", 3751289353907091949),
        ("chord_seconds", 16026878376378009957),
        ("chromatic_scale", 15408354778002420456),
        ("clef_change", 2993902723596988402),
        ("compound_meter", 529748138788643563),
        ("Debussy_Images_9", 15330163832375725192),
        ("dotted_notes", 7200574148542538207),
        ("GoodbyePorkPieHat", 17885058102088707844),
        ("grace_notes_test", 4707126296760185430),
        ("HBD_33", 1995967541613022557),
        ("keysig_d_major", 8479639558437874393),
        ("keysig_eb_major", 12277857186257421530),
        ("keysig_flats_all", 15083331138321548905),
        ("keysig_sharps_all", 12221485693216726321),
        ("KillingMe_36", 5569761018901139432),
        ("ledger_lines", 13091694532632196776),
        ("MahlerLiedVonDE_25", 5827734767748758831),
        ("MendelssohnOp7N1_2", 12724034660735293307),
        ("mixed_durations", 11477553681863818731),
        ("RavelScarbo_15", 1667881528420007715),
        ("rests_all_durations", 8787654006822280500),
        ("SchenkerDiagram_Chopin_6", 10192582817908824402),
        ("SchoenbergOp19N1_21", 15728437755576517875),
        ("sixteenths_32nds", 9694866244778996709),
        ("TestMIDIChannels_3", 12256003527230386818),
        ("text_annotations", 18043226615835002466),
        ("tied_notes", 9861423928596136231),
        ("time_sig_changes", 11951189353532278016),
        ("tuplet_quintuplet", 13690015173221111256),
        ("tuplet_triplet", 2240050896305491555),
        ("two_voices", 820161498571445438),
        ("Webern_Op5N3_22", 7459459093651413026),
        ("whole_notes", 2866824453177741997),
        ("wide_intervals", 759858018049986695),
    ]
    .into_iter()
    .collect();
