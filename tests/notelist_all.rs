...
fn test_all_notelists_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ...
        ("BachEbSonata_20_2sizes", 764511972356707654),
        ("BachEbSonata_20", 764511972356707654),
        ("BachStAnne_63", 2623496343990303184),
        ("barline_types", 3336469603741155452),
        ("bass_clef_melody", 9486584045937805546),
        ("beamed_eighths", 8301825378362581899),
        ("BinchoisDePlus_17", 18130252228357987478),
        ...
        ("Debussy_Images_9", 9684477923778057480),
        ("dotted_notes", 857714639675798198),
        ("GoodbyePorkPieHat", 1130662851827562194),
        ("grace_notes_test", 15366495145983531098),
        ("HBD_33", 6249657814581313444),
        ...
        ("KillingMe_36", 11730875077303670037),
        ("ledger_lines", 8055266743120975078),
        ("MahlerLiedVonDE_25", 15125216271307977136),
        ("MendelssohnOp7N1_2", 5665095226065658526),
        ("mixed_durations", 4123334471969081750),
        ("RavelScarbo_15", 13527457271230990986),
        ("rests_all_durations", 12675055982286837345),
        ("SchenkerDiagram_Chopin_6", 4984710674599772210),
        ("SchoenbergOp19N1_21", 3229219942940883265),
        ("sixteenths_32nds", 16074022202973298030),
        ("TestMIDIChannels_3", 8708942973999359142),
        ...
        ("Webern_Op5N3_22", 17673789573473076330),
