...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 11628794756050636725),
        ("02_cloning_frank_blacks", 18094774922683007497),
        ("03_holed_up_in_penjinskya", 16423985096127768632),
        ("04_eating_humble_pie", 28829165540893353),
        ("05_abigail", 13878854382933531077),
        ("06_melyssa_with_a_y", 5297190059901023391),
        ("07_new_york_debutante", 15690984356087200590),
        ("08_darling_sunshine", 8537121267507389353),
        ("09_swiss_ann", 15110253460682536876),
        ("10_ghost_of_fusion_bob", 2715639509360175901),
        ("11_philip", 11549336831496368347),
        ("12_what_do_i_know", 901580656564646152),
        ("13_miss_b", 7802398173511217960),
        ("14_chrome_molly", 14753613939068779528),
        ("15_selfsame_twin", 5076787299708446050),
        ("16_esmerelda", 17378383512430984220),
        ("17_capital_regiment_march", 8535326359664240477),
        ...
        ("tc_55_1", 8972889853784126958),
        ("tc_ich_bin_ja", 10330857762501062052),
        ("tc_schildt", 10457625322292221581),
        ("tc_schumann_eusebius_play", 16003036351844936921),
        ("tc_schumann_reconnaissance", 17377376872017884626),
        ("tc_old_alpherqt_16", 17681319502731408440),
        ("tc_old_debussy_images_play", 17958932309158265476),
        ("tc_old_kinderszenen_13_6", 11564710681438742035),
        ("tc_old_ravel_scarbo_10", 2817145496059695337),
        ("tc_old_babbitt_guit_8", 2770334878675782906),
        ("tc_old_berlioz_valse_proteus", 11602737532644648886),
        ("tc_old_berlioz_valse_qt", 11602737532644648886),
        ("tc_old_berlioz_valse_trem", 13838257494591908860),
        ("tc_old_berlioz_valse_proteus_tweaked", 8189119438819343371),
        ("tc_old_debussy_images_play_converted", 17958932309158265476),
        ("tc_old_icebreaker_6", 815643057354934039),
        ("tc_old_killingme_play", 11271302534229919985),
        ("tc_old_km_play_scellpoporch", 8212576755906925124),
        ("tc_old_komm_heiliger_geist", 10678486276976470533),
        ("tc_old_komm_heiliger_geist_qt", 6488033621264753409),
        ("tc_old_babbitt_guitar_piece", 2770334878675782906),
