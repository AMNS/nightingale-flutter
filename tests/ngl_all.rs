...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ...
        ("05_abigail", 13530810827721360565),
        ...
        ("tc_old_komm_heiliger_geist", 13048405455737051695),
        ("tc_old_komm_heiliger_geist_qt", 12288831089886495403),
