...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 7737039923100140248),
        ("02_cloning_frank_blacks", 10551577228956890315),
        ("03_holed_up_in_penjinskya", 12763194731467791861),
        ("04_eating_humble_pie", 4669649928586155445),
        ("05_abigail", 6952688033273721275),
        ("06_melyssa_with_a_y", 2698021736604282525),
        ("07_new_york_debutante", 4095027447511383428),
        ("08_darling_sunshine", 16381852832915525019),
        ("09_swiss_ann", 3277456723093696690),
        ("10_ghost_of_fusion_bob", 11430103550682770881),
        ("11_philip", 17209941356138606112),
        ("12_what_do_i_know", 18381634225866317272),
        ("13_miss_b", 9301826806581093503),
        ("14_chrome_molly", 5337884619850339525),
        ("15_selfsame_twin", 12628765477112973449),
        ("16_esmerelda", 15191465884306311099),
        ("17_capital_regiment_march", 10710252402633643627),
    ]
    .into_iter()
    .collect();
