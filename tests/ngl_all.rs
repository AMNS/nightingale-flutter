...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 5101004446552998665),
        ("02_cloning_frank_blacks", 4263267946190126907),
        ("03_holed_up_in_penjinskya", 494081626467455422),
        ("04_eating_humble_pie", 13080201790045959355),
        ("05_abigail", 8886317879880624502),
        ("06_melyssa_with_a_y", 1392169279627987608),
        ("07_new_york_debutante", 17627831597924482511),
        ("08_darling_sunshine", 12899338792063728550),
        ("09_swiss_ann", 9394081232283035999),
        ("10_ghost_of_fusion_bob", 9636066747980574888),
        ("11_philip", 5986543363457252420),
        ("12_what_do_i_know", 7850701582899738313),
        ("13_miss_b", 10193562171382551630),
        ("14_chrome_molly", 13548015437325673262),
        ("15_selfsame_twin", 1597983376970277370),
        ("16_esmerelda", 310414218120609307),
        ("17_capital_regiment_march", 4709003547598226132),
        ("beamed_grace_notes", 14379941249429490903),
        ("tc_02", 1061527611653717865),
        ("tc_03a", 11006956473516575621),
        ("tc_03b", 3989933090702250194),
        ("tc_04", 1779399570524237986),
        ("tc_05", 17573104032836065244),
        ("tc_55_1", 718513652071174268),
        ("tc_ich_bin_ja", 14920034846664662830),
        ("tc_schildt", 2454079282097037204),
        ("tc_schumann_eusebius_play", 13155837734422463970),
        ("tc_schumann_reconnaissance", 6449438185102460516),
        ("tc_old_alpherqt_16", 2931379166722098011),
        ("tc_old_debussy_images_play", 17307368758207906565),
        ("tc_old_kinderszenen_13_6", 6460858769745035332),
        ("tc_old_ravel_scarbo_10", 8963128919448643401),
        ("tc_old_babbitt_guit_8", 4451476403865484417),
        ("tc_old_berlioz_valse_proteus", 2142017860572001793),
        ("tc_old_berlioz_valse_qt", 2142017860572001793),
        ("tc_old_berlioz_valse_trem", 12441015095659676360),
        ("tc_old_berlioz_valse_proteus_tweaked", 7991894565702530371),
        ("tc_old_debussy_images_play_converted", 17307368758207906565),
        ("tc_old_icebreaker_6", 2354695125895967371),
        ("tc_old_killingme_play", 3083297572935443251),
        ("tc_old_km_play_scellpoporch", 14426659089758350109),
        ("tc_old_komm_heiliger_geist", 3357759295732280177),
        ("tc_old_komm_heiliger_geist_qt", 14511836974048388812),
        ("tc_old_babbitt_guitar_piece", 4451476403865484417),
        ("tc_old_pm_calypso", 10290363176593019424),
    ]
    .into_iter()
    .collect();
