...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 14568585875166809649),
        ("02_cloning_frank_blacks", 11816184563673864998),
        ("03_holed_up_in_penjinskya", 7698298452172506263),
        ("04_eating_humble_pie", 12203679788316560172),
        ("05_abigail", 15714106742515034339),
        ("06_melyssa_with_a_y", 685727588675402563),
        ("07_new_york_debutante", 9405534103458278095),
        ("08_darling_sunshine", 11741611478336210671),
        ("09_swiss_ann", 10995427558476227650),
        ("10_ghost_of_fusion_bob", 9729586024826879571),
        ("11_philip", 17273751198840809476),
        ("12_what_do_i_know", 6761808553711439001),
        ("13_miss_b", 9621197247695207922),
        ("14_chrome_molly", 6778428655281270559),
        ("15_selfsame_twin", 12507871586806271771),
        ("16_esmerelda", 5340825692382845217),
        ("17_capital_regiment_march", 16675286890230988841),
        // Tim Crawford scores
        ("tc_02", 17617897160000184279),
        ("tc_03a", 16740411053222493743),
        ("tc_03b", 399235207624343627),
        ("tc_04", 1802183361957963518),
        ("tc_05", 6944866118875105435),
        ("tc_55_1", 7981950342949967026),
        ("tc_ich_bin_ja", 16927476407941517627),
        ("tc_schildt", 7358410141619831871),
    ]
    .into_iter()
    .collect();
