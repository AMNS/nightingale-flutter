...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 13085473304443849785),
        ("02_cloning_frank_blacks", 5686660092942146577),
        ("03_holed_up_in_penjinskya", 14852057883423026671),
        ("04_eating_humble_pie", 13284338795846709607),
        ("05_abigail", 17626121741795952864),
        ("06_melyssa_with_a_y", 4463166853310569730),
        ("07_new_york_debutante", 11560658289983435906),
        ("08_darling_sunshine", 4695188724023791522),
        ("09_swiss_ann", 10788404533649424836),
        ("10_ghost_of_fusion_bob", 9991013703535470728),
        ("11_philip", 4610810974447860018),
        ("12_what_do_i_know", 14604943523370940147),
        ("13_miss_b", 14261329821793153275),
        ("14_chrome_molly", 2578890462742901139),
        ("15_selfsame_twin", 16528030081104957055),
        ("16_esmerelda", 15530097217663794323),
        ("17_capital_regiment_march", 14284759445325627901),
        // Tim Crawford scores
        ("tc_02", 15448736521372678511),
        ("tc_03a", 9411590060775200780),
        ("tc_03b", 12735398539808348291),
        ("tc_04", 5961020654081799988),
        ("tc_05", 2127261802998962132),
        ("tc_55_1", 13091445969723451215),
        ("tc_ich_bin_ja", 18235494689080274712),
        ("tc_schildt", 10302632697928619762),
    ]
    .into_iter()
    .collect();
