...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 10966944299181381390),
        ("02_cloning_frank_blacks", 2086185233091817596),
        ("03_holed_up_in_penjinskya", 15114700120661414504),
        ("04_eating_humble_pie", 14029300476989869247),
        ("05_abigail", 1082325210910978726),
        ("06_melyssa_with_a_y", 12014496966820756242),
        ("07_new_york_debutante", 12300655975400299515),
        ("08_darling_sunshine", 13878407242233438485),
        ("09_swiss_ann", 9704932457370465159),
        ("10_ghost_of_fusion_bob", 10024166332995474002),
        ("11_philip", 15979391865609736024),
        ("12_what_do_i_know", 7539059729234464582),
        ("13_miss_b", 3552052082496717473),
        ("14_chrome_molly", 8302591858668042189),
        ("15_selfsame_twin", 3714934369040743311),
        ("16_esmerelda", 2318012342139909797),
        ("17_capital_regiment_march", 13154437501301740885),
        // Tim Crawford scores
