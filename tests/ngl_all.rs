...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 9182301235755383093),
        ("02_cloning_frank_blacks", 6273738617599102866),
        ("03_holed_up_in_penjinskya", 13987456398196159650),
        ("04_eating_humble_pie", 8760717443833666130),
        ("05_abigail", 788636115633719765),
        ("06_melyssa_with_a_y", 4958718240301183329),
        ("07_new_york_debutante", 3477313448718013778),
        ("08_darling_sunshine", 13047805864516341625),
        ("09_swiss_ann", 8369711951524738334),
        ("10_ghost_of_fusion_bob", 3032678064543692972),
        ("11_philip", 1074840004144138321),
        ("12_what_do_i_know", 8989560009141355033),
        ("13_miss_b", 12088004055351970391),
        ("14_chrome_molly", 1559220758460028520),
        ("15_selfsame_twin", 11732804838499831118),
        ("16_esmerelda", 5383236974894691869),
        ...
        ("tc_old_kinderszenen_13_6", 4138715853929701559),
        ...
        ("tc_old_komm_heiliger_geist", 4582543975769486400),
        ("tc_old_komm_heiliger_geist_qt", 6721162591269897989),
