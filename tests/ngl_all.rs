...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 3788801998649934946),
        ("02_cloning_frank_blacks", 17746400803433041282),
        ("03_holed_up_in_penjinskya", 15545905786775055309),
        ("04_eating_humble_pie", 1529487780254861050),
        ("05_abigail", 7775387742548316626),
        ("06_melyssa_with_a_y", 5013358359639493634),
        ("07_new_york_debutante", 18114533351305810996),
        ("08_darling_sunshine", 11058465259702346103),
        ("09_swiss_ann", 10462038614419812717),
        ("10_ghost_of_fusion_bob", 10436592140537732576),
        ("11_philip", 12252317345762508457),
        ("12_what_do_i_know", 10933588533612155922),
        ("13_miss_b", 7219768388363854072),
        ("14_chrome_molly", 9918508311899935612),
        ("15_selfsame_twin", 1947555065112709039),
        ("16_esmerelda", 5059147228465572480),
        ("17_capital_regiment_march", 18124945376445041913),
