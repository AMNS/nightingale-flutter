...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 6771266833484823660),
        ("02_cloning_frank_blacks", 10138837586417544849),
        ("03_holed_up_in_penjinskya", 3265415527455931885),
        ("04_eating_humble_pie", 17719330926143753005),
        ("05_abigail", 17698929841808689852),
        ("06_melyssa_with_a_y", 9392049332442591276),
        ("07_new_york_debutante", 2343326044330004367),
        ("08_darling_sunshine", 13082837576503091080),
        ("09_swiss_ann", 6798533164880328470),
        ("10_ghost_of_fusion_bob", 704762698623848302),
        ("11_philip", 8546158534297025542),
        ("12_what_do_i_know", 15703815151035250543),
        ("13_miss_b", 15395825755494840685),
        ("14_chrome_molly", 2537816037910320147),
        ("15_selfsame_twin", 9935703582729951914),
        ("16_esmerelda", 14618291251185653674),
