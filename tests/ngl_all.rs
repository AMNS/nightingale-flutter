...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 6877623282624045526),
        ("02_cloning_frank_blacks", 15791230174809423074),
        ("03_holed_up_in_penjinskya", 2618629115224146245),
        ("04_eating_humble_pie", 14062528962962547227),
        ("05_abigail", 5467699751737794755),
        ("06_melyssa_with_a_y", 11259228012041779043),
        ("07_new_york_debutante", 18119254867065021879),
        ("08_darling_sunshine", 2764589028938075987),
        ("09_swiss_ann", 11145548136243031883),
        ("10_ghost_of_fusion_bob", 15981346169127240756),
        ("11_philip", 6953874990302595285),
        ("12_what_do_i_know", 3146990731529171900),
        ("13_miss_b", 14062000509374951444),
        ("14_chrome_molly", 6024718199315947910),
        ("15_selfsame_twin", 16495764681821714606),
        ("16_esmerelda", 10661652647172309277),
        ("17_capital_regiment_march", 17746026064523170852),
    ]
    .into_iter()
    .collect();
