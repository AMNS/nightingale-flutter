...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 18135890499592424377),
        ("02_cloning_frank_blacks", 17251919919445868552),
        ("03_holed_up_in_penjinskya", 8249207790192484944),
        ("04_eating_humble_pie", 13051376681034471328),
        ("05_abigail", 10145804502404212950),
        ("06_melyssa_with_a_y", 17124419680044444111),
        ("07_new_york_debutante", 18360679130299090784),
        ("08_darling_sunshine", 2150189185457200436),
        ("09_swiss_ann", 17627887921260509047),
        ("10_ghost_of_fusion_bob", 7817554215848876451),
        ("11_philip", 17179330479522872317),
        ("12_what_do_i_know", 335560559978444466),
        ("13_miss_b", 16912105811695871149),
        ("14_chrome_molly", 2126680098343717753),
        ("15_selfsame_twin", 6170447920492852160),
        ("16_esmerelda", 13795014031186300187),
        ("17_capital_regiment_march", 15700654874966909907),
    ]
    .into_iter()
    .collect();
