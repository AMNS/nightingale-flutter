...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 18313210781714220292),
        ("02_cloning_frank_blacks", 5349172306841165210),
        ("03_holed_up_in_penjinskya", 9267384546994354250),
        ("04_eating_humble_pie", 6842130610984796690),
        ("05_abigail", 14403519295878907760),
        ("06_melyssa_with_a_y", 9194984061815050539),
        ("07_new_york_debutante", 11659783361553582855),
        ("08_darling_sunshine", 9369672370274063630),
        ("09_swiss_ann", 8778319392462375903),
        ("10_ghost_of_fusion_bob", 13994373386992354278),
        ("11_philip", 5429874478662674847),
        ("12_what_do_i_know", 8989560009141355033),
        ("13_miss_b", 17229175530300120782),
        ("14_chrome_molly", 9036762060326650883),
        ("15_selfsame_twin", 17179996449903969422),
        ("16_esmerelda", 17165533716387629865),
        ("17_capital_regiment_march", 4075203793503548497),
        ...
        ("tc_55_1", 3500412559693162397),
        ("tc_ich_bin_ja", 17117591176325316754),
        ("tc_schildt", 10457625322292221581),
        ("tc_schumann_eusebius_play", 915356958335364422),
        ...
        ("tc_old_berlioz_valse_qt", 4051771586171542178),
        ("tc_old_berlioz_valse_trem", 13394564405269019064),
        ("tc_old_berlioz_valse_proteus_tweaked", 5029438023255252444),
        ("tc_old_debussy_images_play_converted", 8148608601112330816),
        ("tc_old_icebreaker_6", 319682949621721533),
        ("tc_old_killingme_play", 14166581994906434406),
        ("tc_old_km_play_scellpoporch", 11981550525369543220),
        ("tc_old_komm_heiliger_geist", 4170092121280416408),
        ("tc_old_komm_heiliger_geist_qt", 1553491944587613988),
