...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 11833328309428123378),
        ("02_cloning_frank_blacks", 14145790256526882906),
        ("03_holed_up_in_penjinskya", 15367687471060550847),
        ("04_eating_humble_pie", 4172256631576468284),
        ("05_abigail", 12547167777420303572),
        ("06_melyssa_with_a_y", 15820603293334144351),
        ("07_new_york_debutante", 4969503351195527422),
        ("08_darling_sunshine", 11791331122619422080),
        ("09_swiss_ann", 890018918102252303),
        ("10_ghost_of_fusion_bob", 18251318323733964866),
        ("11_philip", 5015282024772112296),
        ("12_what_do_i_know", 17510188948853844583),
        ("13_miss_b", 1963395649366288678),
        ("14_chrome_molly", 3169433014192375233),
        ("15_selfsame_twin", 5676918981888110835),
        ("16_esmerelda", 3719555798247826186),
        ("17_capital_regiment_march", 2142510365620030370),
    ]
    .into_iter()
    .collect();
