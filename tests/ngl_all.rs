...
fn test_all_ngl_command_stream_hashes() {
    ...
    let expected: std::collections::HashMap<&str, u64> = [
        ("01_me_and_lucy", 13452609531855123014),
        ("02_cloning_frank_blacks", 7660537097892063273),
        ("03_holed_up_in_penjinskya", 10118100578486363393),
        ("04_eating_humble_pie", 1675555739407540763),
        ("05_abigail", 13126967345599993522),
        ("06_melyssa_with_a_y", 8824954159399785669),
        ("07_new_york_debutante", 4073805194418978344),
        ("08_darling_sunshine", 14826474775358935113),
        ("09_swiss_ann", 10409324452542928317),
        ("10_ghost_of_fusion_bob", 15871727727207282454),
        ("11_philip", 14908696166576080406),
        ("12_what_do_i_know", 10933588533612155922),
        ("13_miss_b", 4255089562876555345),
        ("14_chrome_molly", 11724204796338543336),
        ("15_selfsame_twin", 6818591317313471296),
        ("16_esmerelda", 4450487946714915478),
